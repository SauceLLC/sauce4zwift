...
const fieldGroups = [{
    ...
    fields: [
        ...
        {id: 'power-last-lap', defaultEn: false, label: 'Last Lap Average', headerLabel: '<ms>bolt</ms> (last)',
    ...
    fields: [
        ...
        {id: 'speed-last-lap', defaultEn: false, label: 'Last Lap Average', headerLabel: '<ms>speed</ms> (last)',
    ...
    fields: [
        ...
        {id: 'hr-last-lap', defaultEn: false, label: 'Last Lap Average', headerLabel: '<ms>ecg_heart</ms> (last)',
    ...
    fields: [
        ...
        {id: 'draft-last-lap', defaultEn: false, label: 'Last Lap Average', headerLabel: '<ms>air</ms> (last)',
         get: x => x.lastLap ? x.lastLap.draft.avg : null, fmt: pwr},
        {id: 'draft-energy', defaultEn: false, label: '<ms>air</ms> (kJ)', get: x => x.stats.draft.kj, fmt: kj,
    ...
    fields: [
        ...
        {id: 'pwr-p5s', defaultEn: false, label: 'Power 5 sec peak', headerLabel: '<ms>bolt</ms> (<ms>trophy</ms> 5s)',
         get: x => x.stats.power.peaks[5].avg, fmt: pwr},
        {id: 'wkg-p5s', defaultEn: false, label: 'Watts/kg 5 sec peak', headerLabel: 'W/kg (<ms>trophy</ms> 5s)',
         get: x => x.stats.power.peaks[5].avg / x.athlete?.weight, fmt: fmtWkg},
        {id: 'pwr-p15s', defaultEn: false, label: 'Power 15 sec peak', headerLabel: '<ms>bolt</ms> (<ms>trophy</ms> 15s)',
         get: x => x.stats.power.peaks[15].avg, fmt: pwr},
        {id: 'wkg-p15s', defaultEn: false, label: 'Watts/kg 15 sec peak', headerLabel: 'W/kg (<ms>trophy</ms> 15s)',
         get: x => x.stats.power.peaks[15].avg / x.athlete?.weight, fmt: fmtWkg},
        {id: 'pwr-p60s', defaultEn: false, label: 'Power 1 min peak', headerLabel: '<ms>bolt</ms> (<ms>trophy</ms> 1m)',
         get: x => x.stats.power.peaks[60].avg, fmt: pwr},
        {id: 'wkg-p60s', defaultEn: false, label: 'Watts/kg 1 min peak', headerLabel: 'W/kg (<ms>trophy</ms> 1m)',
         get: x => x.stats.power.peaks[60].avg / x.athlete?.weight, fmt: fmtWkg},
        {id: 'pwr-p300s', defaultEn: true, label: 'Power 5 min peak', headerLabel: '<ms>bolt</ms> (<ms>trophy</ms> 5m)',
         get: x => x.stats.power.peaks[300].avg, fmt: pwr},
        {id: 'wkg-p300s', defaultEn: false, label: 'Watts/kg 5 min peak', headerLabel: 'W/kg (<ms>trophy</ms> 5m)',
         get: x => x.stats.power.peaks[300].avg / x.athlete?.weight, fmt: fmtWkg},
        {id: 'pwr-p1200s', defaultEn: false, label: 'Power 20 min peak', headerLabel: '<ms>bolt</ms> (<ms>trophy</ms> 20m)',
         get: x => x.stats.power.peaks[1200].avg, fmt: pwr},
        {id: 'wkg-p1200s', defaultEn: false, label: 'Watts/kg 20 min peak', headerLabel: 'W/kg (<ms>trophy</ms> 20m)',
         get: x => x.stats.power.peaks[1200].avg / x.athlete?.weight, fmt: fmtWkg},
        {id: 'spd-p60s', defaultEn: false, label: 'Speed 1 min peak', headerLabel: '<ms>speed</ms> (<ms>trophy</ms> 1m)',
         get: x => x.stats.speed.peaks[60].avg, fmt: spd},
        {id: 'hr-p60s', defaultEn: false, label: 'Heart Rate 1 min peak', headerLabel: '<ms>ecg_heart</ms> (<ms>trophy</ms> 1m)',
